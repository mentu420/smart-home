...
__export(stdin_exports, {
  ...
  getStartEndDay: () => getStartEndDay,
  getToday: () => getToday,
  pick: () => pick,
  transDateToHourMinute: () => transDateToHourMinute,
  transDateToYearMonthDay: () => transDateToYearMonthDay,
  transHourMinuteToDate: () => transHourMinuteToDate,
  transYearMontDayToDate: () => transYearMontDayToDate
});
module.exports = __toCommonJS(stdin_exports);
var import__ = require(".");
var import_language = __toESM(require("../language"));
const formatDate = function(time, format, lang = "CN") {
  const languageEntiy = import_language.default[lang] || {};
