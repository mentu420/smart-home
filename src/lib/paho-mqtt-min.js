  ...
  return (function (p) {
      ...
      for (var k = 0; k < a.length; k++) {
        ...
        127 >= e
          ...
          : (2047 >= e
              ...
              : (65535 >= e
                  ? (b[c++] = ((e >> 12) & 15) | 224)
                  : ((b[c++] = ((e >> 18) & 7) | 240), (b[c++] = ((e >> 12) & 63) | 128)),
                (b[c++] = ((e >> 6) & 63) | 128)),
            (b[c++] = (e & 63) | 128))
      }
      return b
      ...
      for (var k = '', e, g = b; g < b + c; ) {
        ...
        if (!(128 > e)) {
          ...
          if (224 > e) e = 64 * (e - 192) + m
            ...
            var d = a[g++] - 128
            if (0 > d)
              throw Error(f(h.MALFORMED_UTF, [e.toString(16), m.toString(16), d.toString(16)]))
        ...
        65535 < e &&
          ((e -= 65536), (k += String.fromCharCode(55296 + (e >> 10))), (e = 56320 + (e & 1023)))
    ...
    q.prototype.encode = function () {
      ...
      if (3 == this.type) f = u(this.payloadMessage.destinationName, k, d, f)
        ...
        void 0 !== this.willMessage &&
          ((a = a | 4 | (this.willMessage.qos << 3)), this.willMessage.retained && (a |= 32))
      ...
      switch (this.type) {
        case 1:
          ...
          void 0 !== this.willMessage &&
            ((f = u(this.willMessage.destinationName, n(this.willMessage.destinationName), d, f)),
        ...
        case 8:
          for (g = 0; g < this.topics.length; g++)
            (f = u(this.topics[g], c[g], d, f)), (d[f++] = this.requestedQos[g])
          break
        case 10:
          ...
          g = function () {
            this.isReset
              ...
              : (this._client._trace('Pinger.doPing', 'Timed out'),
                this._client._disconnected(h.PING_TIMEOUT.code, f(h.PING_TIMEOUT)))
          }
        this.reset = function () {
          this.isReset = !0
    ...
    d.prototype.subscribe = function (a, b) {
      ...
      b.onFailure &&
        (c.onFailure = function (a) {
          b.onFailure({ invocationContext: b.invocationContext, errorCode: a, errorMessage: f(a) })
        })
      b.timeout &&
    ...
    d.prototype.send = function (a) {
      ...
      if (this.connected)
        ...
        if (
          Object.keys(this._sentMessages).length + this._buffered_msg_queue.length >
          this.disconnectedBufferSize
        )
          throw Error(f(h.BUFFER_FULL, [this.disconnectedBufferSize]))
        0 < a.qos
          ? this._requires_ack(wireMessage)
          : ((wireMessage.sequence = ++this._sequence), this._buffered_msg_queue.push(wireMessage))
    ...
    d.prototype._doConnect = function (a) {
      ...
      this._connectTimeout = new w(this, window, this.connectOptions.timeout, this._disconnected, [
        h.CONNECT_TIMEOUT.code,
        f(h.CONNECT_TIMEOUT),
      ])
    }
    ...
    d.prototype.store = function (a, b) {
      ...
      switch (b.type) {
        case 3:
          ...
          c.payloadMessage = {}
          for (var d = '', e = b.payloadMessage.payloadBytes, g = 0; g < e.length; g++)
            d = 15 >= e[g] ? d + '0' + e[g].toString(16) : d + e[g].toString(16)
          ...
          0 === a.indexOf('Sent:') &&
            (void 0 === b.sequence && (b.sequence = ++this._sequence), (c.sequence = b.sequence))
          break
        default:
    ...
    d.prototype.restore = function (a) {
      ...
      0 === a.indexOf('Sent:' + this._localKey)
        ? ((d.payloadMessage.duplicate = !0), (this._sentMessages[d.messageIdentifier] = d))
    ...
    d.prototype._process_queue = function () {
      for (var a = null, b = this._msg_queue.reverse(); (a = b.pop()); )
        this._socket_send(a),
          this._notify_msg_sent[a] && (this._notify_msg_sent[a](), delete this._notify_msg_sent[a])
    }
    ...
    d.prototype._deframeMessages = function (a) {
      ...
      try {
        ...
        d =
          'undefined' == w.hasOwnProperty('stack') ? w.stack.toString() : 'No Error Stack Available'
    ...
    d.prototype._handleMessage = function (a) {
      ...
      try {
          ...
          case 2:
            ...
            if (0 < this._buffered_msg_queue.length) {
              ...
              for (var g = this._buffered_msg_queue.reverse(); (e = g.pop()); )
                a.push(e),
                  this.onMessageDelivered &&
                    (this._notify_msg_sent[e] = this.onMessageDelivered(e.payloadMessage))
            }
            ...
            c = !1
            this._reconnecting &&
              ((c = !0), (this._reconnectInterval = 1), (this._reconnecting = !1))
        ...
        ;(c =
          ...
          this._disconnected(h.INTERNAL_ERROR.code, f(h.INTERNAL_ERROR, [t.message, c]))
      }
    }
    ...
    d.prototype._disconnected = function (a, b) {
      ...
      if (void 0 !== a && this._reconnecting)
        this._reconnectTimeout = new w(this, window, this._reconnectInterval, this._reconnect)
      else if (
        (this.sendPinger.cancel(),
        this.receivePinger.cancel(),
        this._connectTimeout && (this._connectTimeout.cancel(), (this._connectTimeout = null)),
        ...
        this.socket &&
          ...
          delete this.socket),
        this.connectOptions.uris && this.hostIndex < this.connectOptions.uris.length - 1)
      )
    ...
    var G = function (a, b, c, k) {
      ...
      this.connect = function (a) {
        ...
        if (4 < a.mqttVersion || 3 > a.mqttVersion)
          throw Error(f(h.INVALID_ARGUMENT, [a.mqttVersion, 'connectOptions.mqttVersion']))
        void 0 === a.mqttVersion
          ? ((a.mqttVersionExplicit = !1), (a.mqttVersion = 4))
          : (a.mqttVersionExplicit = !0)
        if (void 0 !== a.password && void 0 === a.userName)
          throw Error(f(h.INVALID_ARGUMENT, [a.password, 'connectOptions.password']))
        if (a.willMessage) {
          if (!(a.willMessage instanceof r))
            throw Error(f(h.INVALID_TYPE, [a.willMessage, 'connectOptions.willMessage']))
        ...
        if (a.hosts) {
          if (!(a.hosts instanceof Array))
            throw Error(f(h.INVALID_ARGUMENT, [a.hosts, 'connectOptions.hosts']))
          if (1 > a.hosts.length)
            throw Error(f(h.INVALID_ARGUMENT, [a.hosts, 'connectOptions.hosts']))
          for (var b = !1, d = 0; d < a.hosts.length; d++) {
            if ('string' !== typeof a.hosts[d])
              throw Error(f(h.INVALID_TYPE, [typeof a.hosts[d], 'connectOptions.hosts[' + d + ']']))
            if (/^(wss?):\/\/((\[(.+)\])|([^\/]+?))(:(\d+))?(\/.*)$/.test(a.hosts[d]))
              if (0 === d) b = !0
              else {
                if (!b)
                  throw Error(
                    f(h.INVALID_ARGUMENT, [a.hosts[d], 'connectOptions.hosts[' + d + ']'])
                  )
              }
            else if (b)
              throw Error(f(h.INVALID_ARGUMENT, [a.hosts[d], 'connectOptions.hosts[' + d + ']']))
          }
          if (b) a.uris = a.hosts
          else {
            if (!a.ports) throw Error(f(h.INVALID_ARGUMENT, [a.ports, 'connectOptions.ports']))
            if (!(a.ports instanceof Array))
              throw Error(f(h.INVALID_ARGUMENT, [a.ports, 'connectOptions.ports']))
            ...
            for (d = 0; d < a.hosts.length; d++) {
              if ('number' !== typeof a.ports[d] || 0 > a.ports[d])
                throw Error(
                  f(h.INVALID_TYPE, [typeof a.ports[d], 'connectOptions.ports[' + d + ']'])
                )
              var b = a.hosts[d],
                g = a.ports[d]
      ...
      this.send = function (a, b, c, d) {
        ...
        if (1 == arguments.length) {
          ...
          if ('undefined' === typeof e.destinationName)
            throw Error(f(h.INVALID_ARGUMENT, [e.destinationName, 'Message.destinationName']))
        } else
          (e = new r(b)),
            (e.destinationName = a),
