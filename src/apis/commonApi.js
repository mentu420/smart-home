...
export const getSms = (data) =>
  request({ url: '/DuanXin.aspx', params: { op: 1 }, data, method: 'POST' })
/**
 * 短信相关接口。op=1
 * **/
 ...
 * **/
export const setUserConfig = (config) => request({ url: '/YongHu.aspx', method: 'POST', ...config })

export const getUserConfig = (config) => request({ url: '/YongHu.aspx', ...config })
